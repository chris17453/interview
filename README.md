...
| [Docunator](https://github.com/chris17453/docu-nator){:target="_blank"} | REPO | python | A safe AI LLM based utilty that documents source code and generates sphynx (web) documentation. |
| [wp-rss-article-re-gen](https://github.com/chris17453/wp-rss-article-re-gen){:target="_blank"} | REPO | python | An AI news article generator that makes new articles based of of original rss content for wordpress |
